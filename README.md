...
This is the relay behind Harbor's **optional** public Watch Together (pub.harbor.site). tiny, stateless, yours to run. Use as baseline to host your own secure private instances. 
